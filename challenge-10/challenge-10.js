(function() {
    ...
    */
    function calculator(operador) {
        return (isOperatorValid(operador) && function(a, b) {
            return (typeof a === 'number' && typeof b === 'number') && operation[operador](a, b)
        })
    }
    ...
    */
    ...
    if (mult) {
        number1 = 10
        number2 = 15
        console.log(showOperationMessage(number1, operationSignal, number2), mult(number1, number2))
    } 
    else {
        console.log(showErrorMessage(operationSignal))
    }
    ...
    if (div) {
        number1 = 10
        number2 = 15
        console.log(showOperationMessage(number1, operationSignal, number2), div(number1, number2))
    } 
    else {
        console.log(showErrorMessage(operationSignal))
    }
    ...
    */
    ...
    operationSignal =  '&'
    var another = calculator(operationSignal)
    if (another) {
        number1 = 10
        number2 = 15
        console.log(showOperationMessage(number1, operationSignal, number2), another(number1, number2))
    } 
    else {
        console.log(showErrorMessage(operationSignal))
    }
