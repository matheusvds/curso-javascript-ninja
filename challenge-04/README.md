...
- Se ainda houver lugares no carro, mas a quantidade de pessoas passadas por
...
carro.adicionarPessoas = function(numPessoas) {
    ...
    if (carro.quantidadePessoas + numPessoas > carro.assentos) {
        ...
        return "Só cabem mais " + vagas + " pessoa" + plural(vagas); 
    }

    carro.quantidadePessoas += numPessoas
    return "Já temos " + carro.quantidadePessoas + " pessoa" + plural(carro.quantidadePessoas) + " no carro!"
}
